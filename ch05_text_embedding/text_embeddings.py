...
def load_football_and_deep_learning_history():
    # tag::classification_model_split_text_and_create_embeddings[]
    ...
    # end::classification_model_split_text_and_create_embeddings[]

    # tag::classification_model_create_embeddings[]
    client = OpenAI()  # uses the environment variable OPENAI_API_KEY
    ...
    # end::classification_model_create_embeddings[]
