...
files = [
    r'ch11_rag_chatbot_streamlit\11.3_pdf_analyzer_functionality\entity_extraction_web_app.py',
    r'ch11_rag_chatbot_streamlit\11.4_sql_database_connection\vanna_chat.py',
    r'ch11_rag_chatbot_streamlit\11.1_and_11.2_streamlit_chatbot_apps\03_simple_rag_app_2.py',
    r'ch11_rag_chatbot_streamlit\11.1_and_11.2_streamlit_chatbot_apps\app_helper_functions.py',
    r'ch11_rag_chatbot_streamlit\11.1_and_11.2_streamlit_chatbot_apps\04_simple_rag_app_3.py',
    r'ch09_graph_rag\9.1_basic_sla_graph.ipynb',
    r'ch08_agentic_rag\8.8_agentic_system_langgraph\building_agents_using_langgraph.ipynb',
    r'ch08_agentic_rag\8.5_accelerating_agents_asyncio\book_snippet_asynchio.py',
    r'ch08_agentic_rag\8.7_mcp_tools\02_create_a_web_agent_playwright.py',
    r'ch08_agentic_rag\8.7_mcp_tools\01_connect_to_playwright.py',
    r'ch08_agentic_rag\8.6_sales_negotiation_agent_openai_sdk\building_agents_with_openai_sdk.ipynb',
    r'ch08_agentic_rag\8.4_building_agentic_system_function_calling\building_agents_without_framework.ipynb',
